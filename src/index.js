...
function main() {
	...
	loadGLTF('model/gltf/Duck.gltf', [0, 0, 0], [0.5, 0.5, 0.5]);  //[5, 0, 0]
	...
	loadGLTF('model/gltf/Holanda/Holanda.gltf', [0, 0, 0], [0.1, 0.1, 0.1]).then(function(gltf){
	...
	loadGLTF('model/gltf/Portugal/ScenePortugal.gltf', [0, 0, 0], [0.01, 0.01, 0.01]).then(function(gltf){
		//'model/gltf/capoeira/Capoeira.gltf
		//[1, 0, 0]
		//console.log('termine gltf!');
		mixerCap = new THREE.AnimationMixer( gltf.scene );
...
function initCannon(){
	...
	meshBody1.addShape(meshShape1);
	meshBody1.position.set(5,3,0);
	world.add(meshBody1);
	...
	meshBody2.position.set(0, 5, 5); //(0, 0.75, 0)
	world.add(meshBody2);
	...
	var meshBody2 = new CANNON.Body({ mass: mass2 });
	meshBody2.addShape(meshShape2);
	meshBody2.position.set(0, 5, -10); //(0, 0.75, 0)
	world.add(meshBody2);
	bodies.push(meshBody2);
	...
	var meshBody2 = new CANNON.Body({ mass: mass2 });
	meshBody2.addShape(meshShape2);
	meshBody2.position.set(0, 10, -5); //(0, 0.75, 0)
	world.add(meshBody2);
	bodies.push(meshBody2);
